            ...
            <div className="rounded-[10px] border border-gray-200 overflow-hidden">
              ...
              <div className="p-4 space-y-3">
                ...
                <p className="text-sm text-gray-500 leading-relaxed border-t border-gray-100 pt-3">
                  This is a preliminary AI assessment only. Your idea will be fully evaluated overnight — scored for feasibility, cost and member impact, and considered alongside all other current priorities before the committee reviews it.
                </p>
              </div>
            </div>
          )}
