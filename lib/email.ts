    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
        ...
        <div style="padding:24px;background:#fff;border-radius:0 0 10px 10px;border:1px solid #ddd;border-top:none">
          ...
          <p style="color:#555;line-height:1.6;font-family:sans-serif">Your idea will be fully evaluated overnight — scored for feasibility, cost and member impact, and considered alongside all other current priorities before the committee reviews it.</p>
