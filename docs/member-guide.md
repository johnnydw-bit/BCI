...
Select the area of the club your idea relates to. See [Section 4](#4-categories) for a description of each category.

---

**How many members does this affect?** *(required)*

Select the option that best describes how widely this improvement would be felt. See [Section 5](#5-impact-levels) for guidance.

---

**Recognition** *(required)*

Choose whether you are happy to be named if your idea is implemented. See [Section 6](#6-recognition) for details.

---

**Email updates**

By default, you will receive an email when your idea is assessed and when its status changes. Tick the opt-out box if you prefer not to receive these emails.
...
> **Note:** Your self-assessed impact score is one input into the overall scoring. The assessment process considers the full picture, including cost, feasibility, and strategic fit.
...
After assessment, your idea is placed in one of the following bands (visible in My Improvements):
...
All emails are sent from `noreply@bramleygolfclub.co.uk`. Add this to your safe senders list to ensure they don't go to spam.
...
Scoring runs every Monday morning. If you submit on a Tuesday, your idea will typically be assessed the following Monday.
